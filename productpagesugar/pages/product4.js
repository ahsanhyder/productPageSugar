    ...
    return(
        ...
        <div style={{ overflowX: 'hidden' }}>
				...
				<div class="container-fluid">
                    ...
                    <div class="row">
						<div class="col text-center">
							<p className={styles.productTitle1}>{stitle}</p>
						</div>
					</div>
					<div class="row">
						<div class="col text-center">
...
export async function getStaticProps(){
    ...
    var config = {
      method: 'get',
      url: 'https://qa.api.sugarcosmetics.com/products/qa/getProductsv2?handle=kohl-of-honour-intense-kajal-01-black-out-black',
      headers: { }
    };
